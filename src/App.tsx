    ...
    <div className={`min-h-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <header className="fixed w-full bg-opacity-80 backdrop-blur-md shadow-md z-50">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
          <div className="text-xl font-bold">Anurag</div>
        ...
        <footer className={`${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'} py-10`}>
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
              ...
              {/* About */}
              <div>
                <h3 className="font-semibold text-lg">Kanta Anuraga Sahoo</h3>
                ...
                <div className="flex justify-center md:justify-start space-x-4 mt-4">
                  ...
                  <a href="https://x.com/KAnuragSah3296" className="hover:text-gray-300"><Twitter size={20} /></a>
                  <a href="https://www.instagram.com/k.anurag01/" className="hover:text-gray-300"><Instagram size={20} /></a>
                  <a href="https://www.linkedin.com/in/kanta-anurag-sahoo-09a7912a4/" className="hover:text-gray-300"><Linkedin size={20} /></a>
                  <a href="https://github.com/Anurag113-sonu" className="hover:text-gray-300"><Github size={20} /></a>
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><a href="https://www.linkedin.com/in/kanta-anurag-sahoo-09a7912a4/" className="hover:text-gray-300">My Account</a></li>
              ...
              <div>
                ...
                <p className="text-sm">Kendujhar, Bhubaneswar, Odisha</p>
                <p className="text-sm">+91 7609973546</p>
                <p className="text-sm">k.anuragsahoo@gmail.com</p>
              </div>
            </div>

            {/* Copyright */}
            <div className="mt-8 border-t border-white/30 pt-4 text-center text-sm">
              &copy; {new Date().getFullYear()} Kanta Anuraga Sahoo. All rights reserved.
            </div>
          </div>
        </footer>
      </main>
